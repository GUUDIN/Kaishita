...
1. Clone the repository:
    ```bash
    git clone --branch feature/mqtt-weight-sending https://github.com/<your-repo>.git
...
2. Install required Arduino libraries:
    ...
    ```
3. Configure Wi-Fi and MQTT broker details in `main/mqtt.cpp`.
...
6. **How It Works**
7. **ESP32 Task Management with FreeRTOS**
8. **Arduino Component Integration**
9. **MQTT Topics and Payloads**
10. **Next Steps**
